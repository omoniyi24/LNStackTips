    ...
    return (
        <>
            <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
                <div
                    className="w-full p-6 m-auto bg-white border-t-4 border-purple-600 rounded-md shadow-md border-top lg:max-w-md">
                    ...
                    <p className="mt-8 text-xs font-light text-center text-gray-700"> Don't have an account? <a href="/signUp"
                                                                                                                className="font-medium text-purple-600 hover:underline">Sign
                        up</a></p>
                </div>
            </div>
        </>
